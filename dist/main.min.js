...
var __vueify_style_dispose__=require("vueify/lib/insert-css").insert(".grid[data-v-e5c4c762] {\n    display: inline-block;\n    margin: -5px;\n}\n.combiGrid[data-v-e5c4c762] {\n    width: calc(100% - 240px);\n    padding: 20px;\n    white-space: nowrap;\n    overflow-x: auto;\n}");!function(){"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default={name:"app",data:function(){return{pixelColours:{a:"#ff0000",b:"#008000",c:"#0000ff",d:"#fff",e:"#000",f:"#ffff00",g:"#800000",h:"#800080",i:"#6441a5",j:"#000080",k:"#006400",l:"#ffd700",m:"#f0e68c",n:"#daa520",o:"#00ffff",p:"#008080",q:"#00ced1",r:"#ffa500",s:"#ff8c00",t:"#ff4500",u:"#ffc0cb",v:"#ff1393",w:"#ffa07a",x:"#858d86",y:"#4c504d"},grid:{size:12,pixelMap:[]},grids:null,settings:{changeOnColourChange:!1,gridPixelSize:35},tool:{drawing:!1,selected:"pen",colour:"",lockScroll:!1},show:{credits:!1}}},watch:{"settings.gridPixelSize":function(){var e=!0,t=!1,o=void 0;try{for(var i,r=this.grids[Symbol.iterator]();!(e=(i=r.next()).done);e=!0){i.value.changePixelDimensions(this.settings.gridPixelSize)}}catch(e){t=!0,o=e}finally{try{!e&&r.return&&r.return()}finally{if(t)throw o}}}},methods:{startDrag:function(){this.tool.drawing=!0,window.addEventListener("touchmove",this.touchDraw)},stopDrag:function(){this.tool.drawing=!1,window.removeEventListener("touchmove",this.touchDraw)},touchDraw:function(e){if(this.tool.drawing&&this.tool.lockScroll){var t=document.elementFromPoint(e.touches[0].clientX,e.touches[0].clientY),o=t.parentElement.parentElement;if("grid"===o.className){var i=o.attributes["grid-id"].nodeValue;this.grids[i].toolUse(t,!0)}}},isScrollLocked:function(){return!0===this.tool.lockScroll?{overflow:"hidden"}:{overflow:"auto"}},keyPressed:function(e){66===e.which?this.tool.selected="pen":69===e.which?this.tool.selected="eraser":73===e.which?this.tool.selected="eyedropper":71===e.which&&(this.tool.selected="fillbucket")}},mounted:function(){window.addEventListener("mousedown",this.startDrag),window.addEventListener("mouseup",this.stopDrag),window.addEventListener("touchstart",this.startDrag),window.addEventListener("touchend",this.stopDrag),this.grids=this.$children.filter(function(e){return!!e.grid}),document.onkeyup=this.keyPressed},created:function(){for(var e=[],t=0;t<12;t++){for(var o=[],i=1;i<13;i++)o.push(12*t+i);e[t]=t%2==1?o.reverse():o}this.grid.pixelMap=e.reverse()}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var __vue__options__="function"==typeof module.exports?module.exports.options:module.exports;__vue__options__.functional&&console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions."),__vue__options__.render=function(){var e=this,t=e.$createElement,o=e._self._c||t;return o("div",{staticClass:"layout",attrs:{id:"appContainer"}},[e.show.credits?o("modal",{on:{close:function(t){e.show.credits=!1}}},[o("h3",{staticStyle:{"border-bottom":"2px solid #202225","padding-bottom":"5px"},attrs:{slot:"header"},slot:"header"},[e._v("Credits")]),e._v(" "),o("p",{attrs:{slot:"body"},slot:"body"},[e._v("Editor Developed by LegendEffects"),o("br"),o("br"),e._v("Original Editor by Claw Studios"),o("br"),o("br"),e._v("Original PixelBot concept invented by Laboratory 424"),o("br"),o("br"),e._v("First editor concept by CaptainPDA")])]):e._e(),e._v(" "),o("importpanel"),e._v(" "),o("exportpanel"),e._v(" "),o("clearpanel"),e._v(" "),o("settingspanel"),e._v(" "),o("div",{staticClass:"combiGrid",style:e.isScrollLocked()},[o("div",{staticClass:"row"},[o("pixelgrid",{attrs:{"grid-id":0}}),e._v(" "),o("pixelgrid",{attrs:{"grid-id":1}})],1),e._v(" "),o("div",{staticClass:"row"},[o("pixelgrid",{attrs:{"grid-id":2}}),e._v(" "),o("pixelgrid",{attrs:{"grid-id":3}})],1)]),e._v(" "),o("toolbox")],1)},__vue__options__.staticRenderFns=[],__vue__options__._scopeId="data-v-e5c4c762",module.hot&&function(){var e=require("vue-hot-reload-api");e.install(require("vue"),!0),e.compatible&&(module.hot.accept(),module.hot.dispose(__vueify_style_dispose__),module.hot.data?e.reload("data-v-e5c4c762",__vue__options__):e.createRecord("data-v-e5c4c762",__vue__options__))}();
