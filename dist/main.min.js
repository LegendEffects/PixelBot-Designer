...
var __vueify_style_dispose__=require("vueify/lib/insert-css").insert(".grid[data-v-e5c4c762] {\n    display: inline-block;\n    margin: -5px;\n}\n.combiGrid[data-v-e5c4c762] {\n    width: calc(100% - 240px);\n    padding: 20px;\n    white-space: nowrap;\n    overflow-x: auto;\n}");!function(){"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default={name:"app",data:function(){return{pixelColours:{a:"#ff0000",b:"#008000",c:"#0000ff",d:"#fff",e:"#000",f:"#ffff00",g:"#800000",h:"#800080",i:"#6441a5",j:"#000080",k:"#006400",l:"#ffd700",m:"#f0e68c",n:"#daa520",o:"#00ffff",p:"#008080",q:"#00ced1",r:"#ffa500",s:"#ff8c00",t:"#ff4500",u:"#ffc0cb",v:"#ff1393",w:"#ffa07a",x:"#858d86",y:"#4c504d"},grid:{size:12,pixelSize:35},grids:null,tool:{drawing:!1,selected:"pen",colour:"",lockScroll:!1},show:{credits:!1,export:{show:!1,content:[]},import:{show:!1,content:""}}}},watch:{"grid.pixelSize":function(){for(var t=0;t<4;t++)this.$children[t].changePixelDimensions(this.grid.pixelSize)}},methods:{startDrag:function(){this.tool.drawing=!0,window.addEventListener("touchmove",this.touchdraw)},stopDrag:function(){this.tool.drawing=!1,window.removeEventListener("touchmove",this.touchdraw)},touchdraw:function(t){if(this.tool.drawing&&this.tool.lockScroll){var e=document.elementFromPoint(t.touches[0].clientX,t.touches[0].clientY),o=e.parentElement.parentElement;if("grid"===o.className){var i=o.attributes["grid-id"].nodeValue;this.grids[i].toolUse(e,!0)}}},getAllGrids:function(){var t="",e=!0,o=!1,i=void 0;try{for(var r,s=this.grids[Symbol.iterator]();!(e=(r=s.next()).done);e=!0){t+="."+r.value.exportAsCommand()}}catch(t){o=!0,i=t}finally{try{!e&&s.return&&s.return()}finally{if(o)throw i}}return t},isScrollLocked:function(){return!0===this.tool.lockScroll?{overflow:"hidden"}:{overflow:"auto"}},copyCommand:function(t){this.$copyText(t)},importText:function(){var t=document.getElementById("importArea").value,e=document.getElementById("importGrid").value;if("!pbd."===t.substring(0,5)){var o=t.slice(5).split(".");if(o<1)return;var i=0,r=!0,s=!1,n=void 0;try{for(var d,a=o[Symbol.iterator]();!(r=(d=a.next()).done);r=!0){var l=d.value;this.grids[i].rleImport(l),i++}}catch(t){s=!0,n=t}finally{try{!r&&a.return&&a.return()}finally{if(s)throw n}}}else if(["!pb1d.","!pb2d.","!pb3d.","!pb4d."].includes(t.substring(0,6))){var c=t.charAt(3);if(c<1||c>4)return;""!==e?this.grids[e-1].rleImport(t.substring(6,t.length)):this.grids[c-1].rleImport(t.subString(6,t.length))}},keyPressed:function(t){66===t.which?this.tool.selected="pen":69===t.which?this.tool.selected="eraser":73===t.which?this.tool.selected="eyedropper":71===t.which&&(this.tool.selected="fillbucket")}},mounted:function(){window.addEventListener("mousedown",this.startDrag),window.addEventListener("mouseup",this.stopDrag),window.addEventListener("touchstart",this.startDrag),window.addEventListener("touchend",this.stopDrag),this.grids=this.$children.filter(function(t){return!!t.grid}),document.onkeyup=this.keyPressed}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var __vue__options__="function"==typeof module.exports?module.exports.options:module.exports;__vue__options__.functional&&console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions."),__vue__options__.render=function(){var t=this,e=t.$createElement,o=t._self._c||e;return o("div",{staticClass:"layout",attrs:{id:"appContainer"}},[t.show.credits?o("modal",{on:{close:function(e){t.show.credits=!1}}},[o("h3",{staticStyle:{"border-bottom":"2px solid #202225","padding-bottom":"5px"},attrs:{slot:"header"},slot:"header"},[t._v("Credits")]),t._v(" "),o("p",{attrs:{slot:"body"},slot:"body"},[t._v("Editor Developed by LegendEffects"),o("br"),o("br"),t._v("Original Editor by Claw Studios"),o("br"),o("br"),t._v("Original PixelBot concept invented by Laboratory 424"),o("br"),o("br"),t._v("First editor concept by CaptainPDA")])]):t._e(),t._v(" "),t.show.export.show?o("modal",{on:{close:function(e){t.show.export.show=!1}}},[o("h3",{staticStyle:{"border-bottom":"2px solid #202225","padding-bottom":"5px"},attrs:{slot:"header"},slot:"header"},[t._v("Export")]),t._v(" "),o("p",{attrs:{slot:"body"},slot:"body"},[t._l(t.show.export.content,function(e,i){return o("span",{key:e.id},[o("p",{staticStyle:{overflow:"auto",padding:"20px"}},[t._v("!pb"+t._s(i)+"d."+t._s(e))]),t._v(" "),o("button",{staticClass:"actionButton darker",on:{click:function(o){return t.copyCommand("!pb"+i+"d."+e)}}},[o("i",{staticClass:"fas fa-copy"})])])}),t._v(" "),o("span",[o("p",{staticStyle:{overflow:"auto",padding:"20px"}},[t._v("!pbd"+t._s(t.getAllGrids()))]),t._v(" "),o("button",{staticClass:"actionButton darker",on:{click:function(e){t.copyCommand("!pbd"+t.getAllGrids())}}},[o("i",{staticClass:"fas fa-copy"})])])],2)]):t._e(),t._v(" "),t.show.import.show?o("modal",{on:{close:function(e){t.show.import.show=!1}}},[o("h3",{staticStyle:{"border-bottom":"2px solid #202225","padding-bottom":"5px"},attrs:{slot:"header"},slot:"header"},[t._v("Import "),o("input",{attrs:{id:"importGrid",type:"number",min:"1",max:"4",value:"1"}})]),t._v(" "),o("p",{attrs:{slot:"body"},slot:"body"},[o("textarea",{attrs:{id:"importArea"}}),t._v(" "),o("button",{staticClass:"activeButton darker",on:{click:t.importText}},[o("i",{staticClass:"fas fa-upload"})])])]):t._e(),t._v(" "),o("div",{staticClass:"combiGrid",style:t.isScrollLocked()},[o("div",{staticClass:"row"},[o("pixelgrid",{attrs:{"grid-id":0}}),t._v(" "),o("pixelgrid",{attrs:{"grid-id":1}})],1),t._v(" "),o("div",{staticClass:"row"},[o("pixelgrid",{attrs:{"grid-id":2}}),t._v(" "),o("pixelgrid",{attrs:{"grid-id":3}})],1)]),t._v(" "),o("toolbox")],1)},__vue__options__.staticRenderFns=[],__vue__options__._scopeId="data-v-e5c4c762",module.hot&&function(){var t=require("vue-hot-reload-api");t.install(require("vue"),!0),t.compatible&&(module.hot.accept(),module.hot.dispose(__vueify_style_dispose__),module.hot.data?t.reload("data-v-e5c4c762",__vue__options__):t.createRecord("data-v-e5c4c762",__vue__options__))}();

},{"vue":"vue","vue-hot-reload-api":13,"vueify/lib/insert-css":15}],2:[function(require,module,exports){
"use strict";var _vue=require("vue"),_vue2=_interopRequireDefault(_vue);function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}module.exports={components:{modal:_vue2.default.component("modal",require("./modal.vue")),pixelGrid:_vue2.default.component("pixelgrid",require("./pixelGrid.vue")),palette:_vue2.default.component("palette",require("./palette.vue")),toolbox:_vue2.default.component("toolbox",require("./toolbox.vue"))}};
